...
namespace iot_developer_devices_iot_central_m2
{
  class Program
  {
    ...
    private const string provisioningIdScope = "0ne00606611";
    private const string deviceId = "room-temp-01";
    private const string devicePrimaryKey = "wkqegmijohdRIRkDJMhFzVN9QhQ/iIN7CNBf5s8Rjhg=";
